...
Graphcraft aims to turn an app's dependency + file architecture graph into a Minecraft-like world. The goal should be to visualize how everything in a project connects together.

## Note from Ryan

Hi, I'm Ryan. I'm an engineer, game developer, product manager, and UX designer.
