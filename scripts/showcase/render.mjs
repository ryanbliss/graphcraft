...
run([
  ...
  ...music,
  "-filter_complex",
  `[0:v]split=2[bg][fg];[bg]scale=1080:1920:force_original_aspect_ratio=increase,crop=1080:1920,boxblur=35:2,eq=brightness=-0.18:saturation=0.55[back];[fg]scale=1080:608[front];[back][front]overlay=0:620,${text("Your code.", 64, 64, 320)},${text("A city to explore.", 64, 64, 400)},${stages(40, 1310)},${text("graphcraftcity.vercel.app", 36, 48, 1450)},scale=in_range=pc:out_range=tv:out_color_matrix=bt709,setsar=1[v]`,
  "-map",
  "[v]",
  "-map",
  "1:a:0",
