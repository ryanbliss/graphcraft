...
run([
  ...
  "1:a:0",
  "-vf",
  `scale=in_range=pc:out_range=tv:out_color_matrix=bt709,setsar=1,${stages(28, "h-74")},${text("graphcraftcity.vercel.app", 19, 48, "h-38", ":enable='gte(t,27)' ")}`,
  ...audio,
  ...video,
  ...metadata,
...
run([
  ...
  ...music,
  "-filter_complex",
  `[0:v]split=2[bg][fg];[bg]scale=720:1280:force_original_aspect_ratio=increase,crop=720:1280,boxblur=35:2,eq=brightness=-0.18:saturation=0.55[back];[fg]scale=720:405[front];[back][front]overlay=0:430,${text("Your code.", 44, 48, 224)},${text("A city to explore.", 44, 48, 279)},${stages(27, 878)},${text("graphcraftcity.vercel.app", 24, 48, 960)},scale=in_range=pc:out_range=tv:out_color_matrix=bt709,setsar=1[v]`,
  "-map",
  "[v]",
  "-map",
  "1:a:0",
...
run([
  ...
  `${destination}/graphcraft-landscape.mp4`,
  "-vf",
  "fps=1/3,scale=384:216,tile=5x2",
  "-frames:v",
  "1",
  "-update",
  "1",
